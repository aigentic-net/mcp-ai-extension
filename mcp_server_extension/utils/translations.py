# Translation utilities for AI extension Tool
...
def get_translations():
    ...
    return {
        "en": {
            "window_title": "AI extension Tool",
            ...
            "save_images_tooltip": "When checked, attached images will be restored when you open AI extension next time",
        ...
        "vi": {
            ...
            "save_images_tooltip": "Khi được chọn, ảnh đính kèm sẽ được khôi phục khi bạn mở AI extension lần sau",
